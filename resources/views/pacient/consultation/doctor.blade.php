                            ...
                            <div class="mt-4">                  
                                <div class="form-row mb-4">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control py-4 text-bunting font-weight-bold" id="inputPrice" name="consultation_price" value="{{$detail_doctor['price_consultation']}}" readonly required>
                                    </div>
                                </div>
                                <div class="form-row">
