...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('record', function (Blueprint $table) {
            ...
            $table->enum('status_consultation', ['waiting-consultation-payment', 'confirmed-consultation-payment', 'consultation-complete' , 'waiting-medical-prescription-payment'])->default('waiting-consultation-payment')->nullable(false);
